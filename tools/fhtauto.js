  ...
  Ξ UPDATE : Wednesday, August 4, 2021 (GMT+8)
    ...
    const questions = [
        ...
        },
        {
            type: "input",
            name: "inputMessage",
            message: "Input text's message (comment) :",
            validate: (val) => val.length != 0 || "Please input text's Message!",
        },
        {
            type: "input",
            name: "perExec",
            message: "Input no. of Commment :",
            validate: (val) => /[0-9]/.test(val) || "Only input numbers",
        },
        {
            type: "input",
            name: "delayTime",
            message: "Input time interval (in milliseconds):",
            validate: (val) => /[0-9]/.test(val) || "Only input numbers",
        },
    ];
    ...
    try {
        ...
        do {
            ...
            for (let i = 0; i < items.length; i++) {
                ...
                console.log("  Ξ ON  : ".bold.red + moment().format("D MMMM YYYY, h:mm:ss a"));
            }
